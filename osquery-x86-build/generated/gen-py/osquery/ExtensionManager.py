...
class Iface(osquery.Extension.Iface):
    def extensions(self):
        pass
...
class Client(osquery.Extension.Client, Iface):
    def __init__(self, iprot, oprot=None):
        osquery.Extension.Client.__init__(self, iprot, oprot)
...
class Processor(osquery.Extension.Processor, Iface, TProcessor):
    def __init__(self, handler):
        osquery.Extension.Processor.__init__(self, handler)
...
options_result.thrift_spec = (
    (0, TType.MAP, 'success', (TType.STRING, 'UTF8', TType.STRUCT, [InternalOptionInfo, None], False), None, ),  # 0
)
